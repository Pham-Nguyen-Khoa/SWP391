...
function toggle(element) {
  ...
  if (answer.style.maxHeight) {
      answer.style.maxHeight = null; // Đóng nội dung
      toggle.textContent = '+'; // Đổi thành dấu cộng
  } else {
      answer.style.maxHeight = answer.scrollHeight + "px"; // Mở nội dung
      toggle.textContent = '−'; // Đổi thành dấu trừ
  }
}